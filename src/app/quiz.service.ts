...
export class QuizService {
  ...
  getQuizzes() {
    ...
    return this.builtInAngularHttpClient.get('https://modern-js.azurewebsites.net/api/HttpTriggerJS1?code=8XD3vN3ehHLdZacBQJQhgUnNst9202gdd5VM3kWCytDkz2nXhia6kA==&name=Ellison%20Wagner');
  ...
  getNumberOfQuizzes(succeed: boolean): Promise<number> {
    ...
    let p = new Promise<number>(
      (resolve, reject) => succeed ? resolve(42) : reject("Failure")
    );
